...
COPY --chown=1000 ./hello-world.groovy /home/groovy/hello-world.groovy
COPY --chown=1000 ./environment-variables.groovy /home/groovy/environment-variables.groovy
